...
CURRENT_ROUND: 1
CURRENT_STATE: PLAN_COMMITTED_READY_FOR_PANEL_AUDIT
RUNNING_JOB: NONE
LAST_PLAN: experiments/plans/COMP-01_round1.md
LAST_RESULT: experiments/results/XMC-01_round1/data_graph_audit.json
...
RESOURCE_NOTE: GPU-1-and-5-idle;disk-available-about-49GB
HARD_STOP: false
```
