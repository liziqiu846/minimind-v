...
CURRENT_ROUND: 2
CURRENT_STATE: VISSUP01_PAIRED_TRAINING_COMPLETE_SCORING_SMOKE_REQUIRED
RUNNING_JOB: none
...
RESOURCE_NOTE: paired_train_complete_control467.7s_visual489.1s;all_training_gates_passed;two_item_scoring_smoke_required
HARD_STOP: false
```
