...
CURRENT_ROUND: 1
CURRENT_STATE: LITMAP05_PLAN_PENDING
RUNNING_JOB: none
...
NEXT_QUEUE: FREEZE_LITMAP05_PLAN_THEN_TEST_UNIQUE_FROZEN_FEATURE_READOUT_BRIDGE
...
RESOURCE_NOTE: LITMAP05 plan pending;no scientific search/readout before plan commit;no training;PROJALLOC roots43202/43203 forbidden;no running job;no final confirmation
HARD_STOP: false
```
