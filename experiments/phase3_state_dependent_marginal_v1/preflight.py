#!/usr/bin/env python3
"""Legality, private-storage, projection, and checkpoint-reuse preflight."""
...
def _synthetic_run(
    ...
    kind = "reused_base" if module is None else "new_candidate"
    return {
...
def _construct(
    ...
    *,
    ...
    try:
        ...
        parameters = [store.for_module(name) for name in MODULES]
        ...
        receipt = {
            ...
            "checks": {
                **construction,
                ...
                "fixed_projection_reproducible": (
                    projection["all_roots_reproducible"]
                ),
    ...
    for state in BASE_STATES:
        ...
        for seed in SEEDS:
            ...
            reuse[state][str(seed)] = {
                ...
                "training_manifest_sha256": source[
                    "training_manifest_sha256"
                ],
                "coordinate_state_sha256": source["coordinate_state_sha256"],
            }
    return {
        "status": "passed",
