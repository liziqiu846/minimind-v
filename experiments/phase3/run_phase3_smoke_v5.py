#!/usr/bin/env python3
"""Run the fixed Phase 3 v5 smoke evaluation."""
...
def main() -> int:
    ...
    def operation():
        ...
        try:
            return execute_evaluation(
                run_mode="smoke", model_ids=["M1-root-none"], filenames=filenames,
    ...
    return execute_with_status("run_phase3_smoke_v5", args.status_output, operation)
